...
where $P_R$ and $P_L$ are the feet position, $I_{N \times N}$ and $0_{N \times N}$ are the identity matrix and zero matrices of degree $N$; and $v\times$ is the left cross product matrix of any vector $v$
